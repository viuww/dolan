...
class OfficeFurnitureListScreen extends StatelessWidget {
  ...
  Widget _searchBar() {
    return Padding(
      ...
      child: TextField(
        decoration: InputDecoration(hintText: 'Nggolet', prefixIcon: const Icon(Icons.search, color: Colors.grey), suffixIcon: const Icon(Icons.menu, color: Colors.grey), contentPadding: const EdgeInsets.all(20), border: textFieldStyle, focusedBorder: textFieldStyle),
      ),
    );
  }
